    ...
    return Scaffold(
      ...
      body: FutureBuilder<Transaction?>(
        future: ref
            ...
            .then((repo) => repo.getById(transactionId)),
        builder: (context, snapshot) {
          ...
          if (transaction == null) {
            return Center(child: Text(l10n.transactionsError));
          }
          ...
          return FutureBuilder(
            future: ref
                .read(walletRepositoryProvider.future)
                .then((repo) => repo.getById(transaction.walletId)),
            builder: (context, walletSnapshot) {
              final walletName = walletSnapshot.data?.name ?? '';
